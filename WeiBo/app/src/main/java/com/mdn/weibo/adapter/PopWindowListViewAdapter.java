...
public class PopWindowListViewAdapter extends BaseAdapter {
    ...
    public PopWindowListViewAdapter(Context context, List<String> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.custom_popwindow, null);
//            view = View.inflate(context, R.layout.custom_popwindow, null);
